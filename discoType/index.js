...
const colors = {
  ...
  'n': '#FF69B4', // HotPink
  'o': '#800080', // Purple
  'p': '#8B4513', // SaddleBrown
  'q': '#556B2F', // DarkOliveGreen
  'r': '#800080', // Purple
  's': '#2E8B57', // SeaGreen
  't': '#FF6347', // Tomato
  'u': '#4682B4', // SteelBlue
  ...
  'x': '#CD5C5C', // IndianRed
  'y': '#32CD32', // LimeGreen
  'z': '#FFA07A', // LightSalmon
  'A': '#FF0000', // Red (same as 'a')
  'B': '#00FF00', // Lime (same as 'b')
  'C': '#0000FF', // Blue (same as 'c')
  'D': '#FFFF00', // Yellow (same as 'd')
  'E': '#FF00FF', // Fuchsia (same as 'e')
  'F': '#00FFFF', // Aqua (same as 'f')
  'G': '#FF4500', // OrangeRed (same as 'g')
  'H': '#8A2BE2', // BlueViolet (same as 'h')
  'I': '#008000', // Green (same as 'i')
  'J': '#800000', // Maroon (same as 'j')
  'K': '#000080', // Navy (same as 'k')
  'L': '#808080', // Gray (same as 'l')
  'M': '#FFD700', // Gold (same as 'm')
  'N': '#FF69B4', // HotPink (same as 'n')
  'O': '#800080', // Purple (same as 'o')
  'P': '#8B4513', // SaddleBrown (same as 'p')
  'Q': '#556B2F', // DarkOliveGreen (same as 'q')
  'R': '#800080', // Purple (same as 'r')
  'S': '#2E8B57', // SeaGreen (same as 's')
  'T': '#FF6347', // Tomato (same as 't')
  'U': '#4682B4', // SteelBlue (same as 'u')
  'V': '#D2B48C', // Tan (same as 'v')
  'W': '#A0522D', // Sienna (same as 'w')
  'X': '#CD5C5C', // IndianRed (same as 'x')
  'Y': '#32CD32', // LimeGreen (same as 'y')
  'Z': '#FFA07A', // LightSalmon (same as 'z')
  ' ': '#000000', // Black for space
};
...
const textFieldChanged = (e) => {
  ...
  container.style.backgroundColor = colors[substring[substring.length-1]];
    if(!started){
        startCounter();
        started=true;
    }
